...
|---|---|---|---|---|---|
| [`v0.1-foundation`](./priorities/v0.1-foundation/README.md) | Ship CoCoder v0.1 — extraction, Oz MVP, docs, public publish | Active | Refine — Sub-Playbook A M4 Checkpoint REACHED 2026-05-23 (all 27 audit remediation rows closed); Sub-Playbook E **Complete** 2026-05-23 (12 ports across 7 runs); **Sub-Playbook B Activated 2026-05-23** (Witness/Interrogate/Solve-target authored, PB-Q1..PB-Q4 awaiting founder gate). Test suite **236/236 all-passing**; 9 product-code bugs surfaced + fixed via the dogfood loop; repo public at `BadGuyFranco/cocoder` (Apache-2.0, branch-protected, community-standards 100%). | Bob + founder | **Next:** founder answers Sub-Playbook B PB-Q1..PB-Q4 (persona scope, template structure, Phil shape, getting-started ownership); then a fresh session executes B Solve (B-S1..B-S5 — persona-identity + `cocoder init` idempotency invariants). Sub-Playbook A Final Check ceremony parallel-tracks. See [`priorities/v0.1-foundation/plans/2026-05-21-personas-template.plan.md`](./priorities/v0.1-foundation/plans/2026-05-21-personas-template.plan.md). |
