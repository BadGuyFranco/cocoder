...
|---|---|---|---|---|---|
| [`v0.1-foundation`](./priorities/v0.1-foundation/README.md) | Ship CoCoder v0.1 — extraction, Oz MVP, docs, public publish | Active | Refine — Sub-Playbook A M4 Checkpoint REACHED 2026-05-23; Sub-Playbook E **Complete** 2026-05-23; Sub-Playbook B Activated 2026-05-23 (W/I/S authored, PB-Q1..PB-Q4 awaiting founder); **Sub-Playbook F (structural cleanup) inserted 2026-05-23 post-code-quality-review** as a B Solve prerequisite (FP-Q1 + FP-Q2 awaiting founder; FB-1/FB-2/FB-3 unblock B-M3 + protect B-S2 fixture capture). Test suite **236/236 all-passing**; 9 product-code bugs surfaced + fixed via the dogfood loop; repo public at `BadGuyFranco/cocoder`. | Bob + founder | **Next:** founder answers Sub-Playbook F FP-Q1 + FP-Q2 (contracts validation scope, helpers module organization). Then a fresh session executes F Solve + Expand (FB-1 → FB-2 → FB-3). Then PB-Q1..PB-Q4 + B Solve. See [`priorities/v0.1-foundation/plans/2026-05-23-structural-cleanup.plan.md`](./priorities/v0.1-foundation/plans/2026-05-23-structural-cleanup.plan.md) and the [updated v0.1 completion plan](./priorities/v0.1-foundation/plans/2026-05-23-v0.1-completion.plan.md). |
