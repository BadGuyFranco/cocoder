...
**Charter:** [0001](./0001-rebuild-charter.md) · **Builds on:** [0003](./0003-data-model-hybrid.md) (stability split), [0005](./0005-personas-and-subtasks.md) (sub-task→Play), [0007](./0007-write-scope-enforcement.md) (create-priority scope)
**Amends:** [0005](./0005-personas-and-subtasks.md) — "sub-task" is renamed **Play**, and a Play may be *interactive + governance-writing* (not only a headless read-mostly sub-agent dispatch).
...
- **Play** — a reusable procedure runnable without its author. **Renames ADR-0005's "sub-task."** One
...
- **ADR-0005 vocabulary changes** (sub-task→Play) and gains the interactive-Play kind; the registry,
