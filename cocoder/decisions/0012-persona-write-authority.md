...
Authored on the `oz-control-plane-design` branch and reconciled onto `main` during the v0.5 Phase 2 governance reconciliation (2026-05-28). ADR-0009 (orchestration services, PR #50) and ADR-0011 (v0.1 closeout) are on `main`; ADR-0010 (run-lifecycle / Oz control-plane build) remains reserved on the `oz-control-plane-design` branch (PR #51), pending the v0.4 run.
