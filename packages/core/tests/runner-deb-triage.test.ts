...
import { type DebStatus, type DebTerminalSnapshot, type Git, type MakeJudge, type NudgeRequest, type RunnerIO, deriveTerminalProjection, openRunStore, renderDebStatus, runRun } from '../src/index.js'
import {
  askFounderContinue,
  baseDeps,
  bob,
