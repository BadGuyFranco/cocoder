  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 4, minWidth: 0, flex: '1 1 auto', position: 'relative' }}>
      ...
      <div ref={adderRef} style={{ position: 'relative', flexShrink: 0 }}>
        ...
        {adderOpen && (
          <div style={{ position: 'absolute', top: 'calc(100% + 6px)', left: 0, minWidth: 320, background: 'var(--cb-surface-glass)', backdropFilter: 'blur(var(--cb-glass-blur))', WebkitBackdropFilter: 'blur(var(--cb-glass-blur))', border: '1px solid var(--cb-border)', borderRadius: 'var(--cb-radius-lg)', boxShadow: '0 8px 24px rgba(0,0,0,0.4), inset 0 1px 0 0 var(--cb-glass-highlight)', padding: 6, zIndex: 50 }}>
