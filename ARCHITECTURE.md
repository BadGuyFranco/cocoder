...
- Drift audit spine: engine owner [`packages/core/src/drift/`](./packages/core/src/drift/); owner map [`docs/drift-audit-ownermap.md`](./docs/drift-audit-ownermap.md); real-path proof [`scripts/proof-drift-audit.mjs`](./scripts/proof-drift-audit.mjs). Doc-reference CI gate and doc-type taxonomy: policy owner [`docs/freshness-policy.md`](./docs/freshness-policy.md); resolver [`packages/core/src/drift/resolve-doc-references.ts`](./packages/core/src/drift/resolve-doc-references.ts); gate test [`packages/core/tests/drift-doc-reference-gate.test.ts`](./packages/core/tests/drift-doc-reference-gate.test.ts) (runs under `pnpm test`).
